...
impl PassiveSuggestionsModel {
    ...
    fn handle_finished_stream(
        ...
        // (无云端 auth + ShowSuggestions proto 动作 BYOE 无法合成)。
        // TODO(BYOE-suggestions): 后续若要在 BYOE 下复刻"Suggested Workflow / Rule"芯片,
        // 需新增独立 BYOE one-shot 链路:主流结束 → 让 LLM 输出结构化 JSON candidate
